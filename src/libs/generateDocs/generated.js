 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').adosc({'short period': 5, 'long period': 5}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').adx({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').adxr({period: 5}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').apo({'short period': 3, 'long period': 3, real: close}) */
/**
 * @Summary Aroon
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').aroon({period: 5}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').aroonosc({period: 6}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').atr({period: 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').bbands({period: 4, stddev: 4, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').cci({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').cmo({period: 6, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').cvi({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').decay({period: 6, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').di({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').dpo({period: 3, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').dx({period: 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').ema({period: 4, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').fisher({period: 6}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').fosc({period: 4, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').kvo({'short period': 4, 'long period': 4}) */
/**
 * @Summary Lag
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').lag({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').linregintercept({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').linregslope({period: 4, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').macd({'short period': 4, 'long period': 4, 'signal period': 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').mass({period: 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').max({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').md({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').mfi({period: 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').mom({period: 3, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').msw({period: 3, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').natr({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').ppo({'short period': 3, 'long period': 3, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').psar({'acceleration factor step': 5.3919388582020105, 'acceleration factor maximum': 5.742413895201344}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').qstick({period: 5}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').roc({period: 6, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').rocr({period: 4, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').rsi({period: 5, real: close}) */
/**
 * @Summary Vector Sine
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').sma({period: 6, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').stddev({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').stderr({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').stoch({'%k period': 6, '%k slowing period': 4, '%d period': 5}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').stochrsi({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').sum({period: 3, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').tema({period: 4, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').trima({period: 6, real: close}) */
/**
 * @Summary Trix
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').trix({period: 6, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').tsf({period: 5, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').ultosc({'short period': 5, 'medium period': 6, 'long period': 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').vhf({period: 3, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').vidya({'short period': 6, 'long period': 4, alpha: 6.5531848733509985, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').volatility({period: 3, real: close}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').vosc({'short period': 6, 'long period': 6}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').wilders({period: 5, real: close}) */
/**
 * @Summary Williams %R
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').willr({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').zlema({period: 3, real: close}) */