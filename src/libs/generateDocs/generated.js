 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').adosc({'short period': 4, 'long period': 5}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').apo({'short period': 5, 'long period': 6, real: 'close'}) */
/**
 * @Summary Aroon
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').aroonosc({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').atr({period: 3}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').bbands({period: 3, stddev: 4, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').cvi({period: 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').dema({period: 4, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').edecay({period: 4, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').hma({period: 6, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').kama({period: 5, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').kvo({'short period': 5, 'long period': 5}) */
/**
 * @Summary Lag
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').lag({period: 3, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').linreg({period: 3, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').macd({'short period': 5, 'long period': 5, 'signal period': 6, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').md({period: 3, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').min({period: 3, real: 'close'}) */
/**
 * @Summary Momentum
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').mom({period: 5, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').msw({period: 6, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').natr({period: 6}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').ppo({'short period': 3, 'long period': 4, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').psar({'acceleration factor step': 4.155103912752575, 'acceleration factor maximum': 3.965032881832781}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').rocr({period: 6, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').stoch({'%k period': 4, '%k slowing period': 6, '%d period': 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').stochrsi({period: 6, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').sum({period: 4, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').trima({period: 5, real: 'close'}) */
/**
 * @Summary Trix
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').trix({period: 3, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').ultosc({'short period': 5, 'medium period': 5, 'long period': 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').var({period: 3, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').vhf({period: 6, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').vidya({'short period': 3, 'long period': 3, alpha: 6.063526040116617, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').vosc({'short period': 6, 'long period': 5}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').vwma({period: 4}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').wma({period: 6, real: 'close'}) */
/**
 ...
 * @example
 * monkeyset.fetch('sets').last(20).convert('ohlc').zlema({period: 6, real: 'close'}) */